...
import privacyImg from "../../assets/optimized/tnc.webp";
...
export default function PrivacyPolicy() {
  const content = [
    { type: "h2", text: "What is this Privacy Policy for?" },
    {
      type: "p",
      text: "This privacy policy is for this website and governs the privacy of its users who choose to use it. The policy sets out the different areas where user privacy is concerned and outlines the obligations & requirements of the users, the website and website owners. Furthermore the way this website processes, stores and protects user data and information will also be detailed within this policy.",
    },
    ...
    {
      type: "p",
      text: "The General Data Protection Regulation (GDPR) (Regulation (EU) 2016/679) is a privacy and data protection regulation in the European Union (EU) became enforceable from May 25th 2018 and requires no enabling legislation so automatically becomes binding and applicable on that date. The GDPR imposes new obligations on organisations that control or process relevant personal data and introduces new rights and protections for EU data subjects. The GDPR applies to data processing carried out by organisations operating within the EU. It also applies to organisations outside the EU that offer goods or services to individuals in the EU.",
    },
    {
      type: "p",
    ...
    },
    {
      type: "ul",
      items: [
        "Website Data Collection & Consent, Privacy Policy: we will only collect and use customer data in accordance with our GDPR obligations.",
    ...
    {
      type: "p",
      text: "During the booking or travel card application process we may ask for your name, postal address, e-mail address, car registration number and a contact telephone number. We will also ask for your credit/debit card details (including card number, cardholder name and expiry date) in order to take payment and confirm your booking.",
    },
    ...
    },
    {
      type: "ul",
      items: [
        "We need your 'name' so we can confirm to the lounge, car park operator, or travel card provider who the booking/application is for",
        "For parking and lounge bookings we need your 'credit card' details so that we can collect payment for your booking",
    ...
    {
      type: "p",
      text: "All the information you give us is protected by a secure server. The secure server software SSL (Secure Socket Layers) encrypts all information you enter before it is sent to us. We also have a Firewall (security software) in place to protect our internal information from the Internet.",
    },
    ...
    {
      type: "p",
      text: "Cookies are small files saved to the user's computers hard drive that track, save and store information about the user's interactions and usage of the website. This allows the website, through its server to provide the users with a tailored experience within this website.",
    },
    {
      type: "p",
      text: "Users are advised that if they wish to deny the use and saving of cookies from this website on to their computers hard drive they should take necessary steps within their web browsers security settings to block all cookies from this website and its external serving vendors.",
    },
    {
      type: "p_linked",
      parts: [
        "This website uses tracking software to monitor its visitors to better understand how they use it. This software is provided by Google Analytics which uses cookies to track visitor usage. The software will save a cookie to your computers hard drive in order to track and monitor your engagement and usage of the website, but will not store, save or collect personal information. You can read Google's privacy policy here for further information ",
        {
          ...
          label: "https://www.google.com/privacy.html",
        },
        ".",
      ],
    },
    ...
    { type: "h2", text: "Social Media Platforms" },
    {
      type: "p",
      text: "Communication, engagement and actions taken through external social media platforms that this website and its owners participate on are custom to the terms and conditions as well as the privacy policies held with each social media platform respectively.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "This website may use social sharing buttons which help share web content directly from web pages to the social media platform in question. Users are advised before using such social sharing buttons that they do so at their own discretion and note that the social media platform may track and save your request to share a web page respectively through your social media platform account.",
    },
  ];
            ...
            if (block.type === "h2") {
              return (
                ...
                >
                  <Typography
                    variant="h5"
                    sx={{ fontWeight: 800, mt: idx === 0 ? 0 : 4, mb: 1 }}
                  >
                    {block.text}
                  </Typography>
                  <Divider sx={{ mb: 2 }} />
