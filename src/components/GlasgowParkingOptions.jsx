...
import parking1 from "../assets/GlasgowImages/parking-1.webp"; // You can replace these with Dublin-specific images
import parking2 from "../assets/GlasgowImages/parking-2.webp";
import parking3 from "../assets/GlasgowImages/parking-3.webp";
import parking4 from "../assets/GlasgowImages/parking-4.webp";
import parking5 from "../assets/GlasgowImages/parking-5.webp";
import backgroundImageParking from "../assets/GlasgowImages/bg-parking.webp";

export default function GlasgowParkingOptions() {
    ...
    >
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            Choose from a wide range of parking services tailored to your needs:
          </Typography>
        </Box>
