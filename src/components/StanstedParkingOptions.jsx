...
export default function StanstedParkingOptions() {
  const parkingOptions1 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Drive to the terminal, hand over your keys, and head to departures while a valet parks your car securely. Perfect for families or business travellers.",
         image: parking1,
    },
    {
      id: 2,
      ...
      titleColor: "#F59E0B",
      description:
        "Park close to the terminal for fast access. Great for short visits or quick pick-ups and drop-offs.",
      image: parking2,
    },
  ];
  ...
  const parkingOptions2 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Best value for extended trips. Located further out but supported by frequent free shuttle transfers.",
      image: parking3,
    },
    {
      id: 4,
      ...
      titleColor: "#F59E0B",
      description:
        "Budget-friendly and reliable. Park off-site and transfer to the terminal in minutes by shuttle.",
      image: parking4,
    },
  ];
