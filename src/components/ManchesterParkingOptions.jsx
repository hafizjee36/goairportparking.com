...
import parking1 from "../assets/ManchesterImages/parking-1.webp";
...
export default function ManchesterParkingOptions() {
  const parkingOptions1 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Drop your car at the terminal entrance, hand your keys to an attendant, and proceed directly to check-in. Ideal if you're short on time or have heavy luggage.",
      image: parking1,
    },
    {
      id: 2,
      ...
      titleColor: "#F59E0B",
      description:
        "Stay close to terminals 1, 2, or 3. Excellent for brief journeys, business travellers, or when you want minimal walking distance.",
      image: parking2,
    },
  ];
  ...
  const parkingOptions2 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "For trips of several days or more. Usually further away but with frequent shuttle buses or free/low-cost services, best value for money.",
      image: parking3,
    },
    {
      id: 4,
      ...
      titleColor: "#F59E0B",
      description:
        "Park further out, then take a shuttle or bus service to the terminals. Cheapest option but involve longer transfer times to the airport.",
      image: parking4,
    },
  ];
