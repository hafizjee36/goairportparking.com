...
export default function LeedsParkingOptions() {
  const parkingOptions1 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Drive straight to the terminal, hand over your keys, and head to departures while a valet parks your car securely. Perfect for families or business travellers.",
         image: parking1,
    },
    {
      id: 2,
      ...
      titleColor: "#F59E0B",
      description:
        "Park within walking distance of the terminal. Ideal for short breaks, quick pick-ups, or business travel.",
      image: parking2,
    },
  ];
  ...
  const parkingOptions2 = [
    ...
    },
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Budget-friendly off-site option with fast, free shuttle transfers to the terminal.",
      image: parking4,
    },
  ];
    ...
    >
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
            Choose from a selection of parking services to suit your travel style:
          </Typography>
        </Box>
        ...
        >
          ...
          <Box className="side-1" sx={{ flex: 1, order: { xs: 2, lg: 1 } }}>
            ...
            >
              ...
              >
                Choose from a selection of parking services to suit your travel style:</Typography>
            </Box>
