...
export default function LeedsPricingSection() {
  const pricingData = [
    {
      service: "Meet & Greet",
      price: "£45–£80 per day",
    ...
    },
    {
      ...
      price: "£30–£55 half day, £55–£75 full day",
    ...
    },
    {
      ...
      price: "£35–£55 per week",
      details: "Fast shuttle transfer to terminal"
    }
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 6, md: 8 } }}>
      ...
      >
        ...
        >
          Leeds Bradford Airport Product Pricing
        </Typography>
      ...
      >
        ...
        >
          ...
          >
          Booking early ensures the lowest prices and best availability.
          </Typography>
        </Box>
      </Box>
    </Container>
