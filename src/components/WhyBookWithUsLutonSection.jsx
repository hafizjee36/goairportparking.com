...
export default function WhyBookWithUsBristolSection() {
  const features = [
    {
      icon: compareImg,
      title: "Compare & Save",
      description: "Instantly view the best parking options at Luton Airport"
    },
    {
      icon: securityIcon,
      title: "Secure & Reliable",
      description: " All providers are vetted with CCTV, patrols, and Park Mark or equivalent accreditation"
    },
    {
      icon: transparencyImg,
      title: "Transparency Pricing",
      description: "No hidden extras; full shuttle and cancellation details included"
    },
    {
      icon: reviewsImg,
      title: "Trusted Reviews",
      description: "Feedback from real customers helps you book with confidence"
    },
    {
      icon: prebookImg,
      title: "Book Early & Save More",
      description: " Lock in discounts by booking in advance"
    }
  ];
