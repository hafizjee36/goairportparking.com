...
export default function BristolPricingSection() {
  const pricingData = [
    {
      service: "Meet & Greet",
      price: "£50–£85 per day",
    ...
    },
    {
      ...
      details: "Fast shuttle service direct to terminal"
    }
  ];
  ...
  return (
    <Container maxWidth="lg" sx={{ py: { xs: 6, md: 8 } }}>
      ...
      >
        ...
        >
          Bristol Airport Product Pricing
        </Typography>
      ...
      >
        ...
        >
          ...
          >
         Booking in advance secures the best availability and lowest prices.
          </Typography>
        </Box>
      </Box>
    </Container>
