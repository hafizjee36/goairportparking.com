...
export default function LutonParkingOptions() {
  const parkingOptions1 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Drive to the terminal, hand over your keys, and walk straight to departures while your car is parked safely for you. Perfect for families or business travelers.",
         image: parking1,
    },
    {
      id: 2,
      ...
      titleColor: "#F59E0B",
      description:
        "Park close to the terminal for maximum convenience. Ideal for short trips or quick drop-offs.",
      image: parking2,
    },
  ];
  ...
  const parkingOptions2 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Great value for extended travel. Located further away but with frequent free shuttle transfers.",
      image: parking3,
    },
    {
      id: 4,
      ...
      titleColor: "#F59E0B",
      description:
        "The most cost-effective option. Park off-site and take a fast, reliable shuttle to the terminal.",
      image: parking4,
    },
  ];
    ...
    >
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
           Choose from a range of parking services designed for every traveler:
          </Typography>
        </Box>
        ...
        >
          ...
          <Box className="side-1" sx={{ flex: 1, order: { xs: 2, lg: 1 } }}>
            ...
            >
              ...
              >
                Choose from a range of parking services designed for every traveler:</Typography>
            </Box>
