...
const StripeForm = ({
  ...
  // Function to determine currency based on airport
  const getCurrency = () => {
    ...
    if (airportLower.includes('dublin')) {
      return 'eur';
    }
    
    // If airport contains "dubai" or is DXB, use AED
    if (airportLower.includes('dubai') || airportLower === 'dxb') {
      return 'aed';
    }
  ...
  const getCurrencySymbol = () => {
    ...
    return currency === 'aed' ? 'AED' : currency === 'eur' ? '€' : '£';
  };
            ...
            <PaymentElement
              options={{
                ...
                defaultValues: {
                  billingDetails: {
                    address: {
                      country: getCurrency() === 'eur' ? 'IE' : 'GB', // Set country based on currency
                    },
                  },
                },
              }}
