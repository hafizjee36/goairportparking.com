...
const BookingFailure = () => {
  ...
  // Get charge breakdown (may not be available for failed payments)
        ...
        <Container maxWidth="lg" sx={{ py: 6 }}>
          ...
          >
            <Box sx={{ textAlign: 'center', mb: 6 }}>
              ...
              <Typography variant="h3" gutterBottom sx={{ fontWeight: 800, color: 'error.main' }}>
                Payment Failed
              </Typography>
              <Typography variant="h6" color="text.secondary" sx={{ mb: 2 }}>
                Unfortunately, your payment could not be processed. No charges have been made to your account.
              </Typography>
              {bookingReference && (
                <Chip
                  ...
                  <CardContent sx={{ p: 4 }}>
                    ...
                    <Alert severity="warning" sx={{ mb: 0 }}>
                      <Typography variant="body2">
                        Your booking details have been saved. Please try again or contact support for assistance.
                      </Typography>
                    </Alert>
                  </CardContent>
                </Card>
