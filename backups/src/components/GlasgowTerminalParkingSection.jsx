...
import terminalImg from "../assets/GlasgowImages/terminal-img.webp";
import terminalIcon from "../assets/GlasgowImages/terminal-icon.webp";

export default function GlasgowTerminalParkingSection() {
  const features = [
    {
      icon: terminalIcon,
      title: "Short Stay car parks located beside Terminals 1 and 2",
    },
    {
      icon: terminalIcon,
      ...
      >
        ...
        >
          <Box
            component="img"
            src={terminalImg}
            alt="Terminal Parking - Family with luggage at Glasgow airport"
            sx={{
              width: "445px",
              height: "448px",
