...
export default function WhyBookWithUsStanstedSection() {
  const features = [
    {
      icon: compareImg,
      title: "Compare & Save",
      description: "See the best parking prices instantly"
    },
    {
      icon: securityIcon,
      title: "Secure & Reliable",
      description: "Only trusted, accredited providers listed"
    },
    {
      icon: transparencyImg,
      title: "Transparency Pricing",
      description: "Clear costs, shuttle details, and cancellation options"
    },
    {
      icon: reviewsImg,
      title: "Trusted Reviews",
      description: "Ratings from real customers to guide your choice"
    },
    {
      icon: prebookImg,
      title: "Book Early for Best Rates ",
      description: "Secure your space and save more by booking ahead"
    }
  ];
