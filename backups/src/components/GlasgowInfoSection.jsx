...
import heroImage from "../assets/GlasgowImages/hero-image.webp";

export default function GlasgowInfoSection() {
  return (
        ...
        >
          ...
          >
            <Box
              component="img"
              src={heroImage}
              alt="Father and son enjoying their travel - Glasgow Airport Parking"
              sx={{
                width: "100%",
                height: "auto",
                display: "block",
