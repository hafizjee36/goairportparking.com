...
export default function BirminghamTerminalParkingSection() {
  const features = [
    {
      icon: terminalIcon,
      title: "Multi-Storey and Short Stay options near the main terminal",
    },
    {
      icon: terminalIcon,
      title: "Walk to check-in within minutes",
    },
      {
      icon: terminalIcon,
      title: "Perfect for short trips or business travel",
    },
    {
      icon: terminalIcon,
      title: "Slightly higher cost but maximum convenience",
    }
  ];
    ...
    <Container maxWidth="lg" sx={{ py: { xs: 6, md: 8 } }}>
      ...
      >
        ...
        >
          ...
          >
           If proximity is your priority, terminal parking offers the fastest access:
          </Typography>
