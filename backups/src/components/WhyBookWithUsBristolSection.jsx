...
export default function WhyBookWithUsLutonSection() {
  const features = [
    {
      icon: compareImg,
      title: "Compare & Save",
      description: "Instantly view the best parking deals at Bristol Airport"
    },
    {
      icon: securityIcon,
      title: "Secure & Reliable",
      description: "Only vetted providers with 24/7 security listed"
    },
    {
      icon: transparencyImg,
      title: "Transparency Pricing",
      description: "No hidden extras, with clear shuttle and cancellation details"
    },
    {
      icon: reviewsImg,
      title: "Trusted Reviews",
      description: "Book with confidence using feedback from real travellers"
    },
    {
      icon: prebookImg,
      title: "Book Early & Save",
      description: "Lock in lower prices and guarantee your space"
    }
  ];
