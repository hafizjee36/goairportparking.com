...
export default function BristolParkingOptions() {
  const parkingOptions1 = [
    {
      ...
      titleColor: "#F59E0B",
      description:
        "Drive to the terminal, hand over your keys, and head to departures while your car is parked securely for you. Ideal for business travellers and families.",
         image: parking1,
    },
    {
      id: 2,
      ...
      titleColor: "#F59E0B",
      description:
        "Park close to the terminal with quick access to check-in. Best for short trips or quick pick-ups.",
      image: parking2,
    },
  ];
  ...
  const parkingOptions2 = [
    ...
    },
    {
      ...
      titleColor: "#F59E0B",
      description:
        "The most affordable option. Park off-site and take a fast shuttle transfer to the airport.",
      image: parking4,
    },
  ];
    ...
    >
      <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          >
           Bristol Airport offers several parking solutions for different needs:
          </Typography>
        </Box>
        ...
        >
          ...
          <Box className="side-1" sx={{ flex: 1, order: { xs: 2, lg: 1 } }}>
            ...
            >
              ...
              >
                Bristol Airport offers several parking solutions for different needs:</Typography>
            </Box>
