...
export default function WhyBookWithUsBirminghamSection() {
  const features = [
    {
      icon: compareImg,
      title: "Compare & Save",
      description: "Instantly compare Birmingham Airport parking prices in one place."
    },
    {
      icon: securityIcon,
      title: "Trusted & Secure",
      description: "Only trusted, Park Mark-accredited providers listed"
    },
    {
      icon: transparencyImg,
      title: "No Hidden Fees",
      description: "Clear policies, shuttle details, and cancellation terms"
    },
    {
      icon: reviewsImg,
      title: "Verified Reviews",
      description: "Real customer feedback helps you choose confidently"
    },
    {
      icon: prebookImg,
      title: "Pre-Book & Relax",
      description: "Guarantee your spot and save more by booking early"
    }
  ];
