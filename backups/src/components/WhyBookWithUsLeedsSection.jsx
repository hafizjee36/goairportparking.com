...
export default function WhyBookWithUsLeedsSection() {
  const features = [
    {
      icon: compareImg,
      title: "Compare & Save",
      description: "Instantly see the best Leeds Bradford parking options"
    },
    {
      icon: securityIcon,
      title: "Secure & Reliable",
      description: "Only trusted, vetted providers listed with strong security standards"
    },
    {
      icon: transparencyImg,
      title: "Transparency Pricing",
      description: "No hidden costs; full shuttle and cancellation details provided"
    },
    {
      icon: reviewsImg,
      title: "Trusted Reviews",
      description: "Genuine ratings from customers to help you choose confidently"
    },
    {
      icon: prebookImg,
      title: "Book Early & Save More",
      description: "Guarantee availability and secure lower prices by booking in advance"
    }
  ];
