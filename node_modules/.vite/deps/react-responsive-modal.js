...
// node_modules/react-responsive-modal/node_modules/@bedrock-layout/use-forwarded-ref/node_modules/@bedrock-layout/use-stateful-ref/lib/index.m.js
...
// node_modules/react-responsive-modal/node_modules/@bedrock-layout/use-forwarded-ref/lib/index.m.js
...
var CloseIcon = ({ classes: classes$1, classNames, styles, id, closeIcon, onClick }) => (0, import_jsx_runtime.jsx)("button", {
  id,
  className: (0, import_classnames.default)(classes$1.closeButton, classNames?.closeButton),
...
var Modal = import_react3.default.forwardRef(({ open, center, blockScroll = true, closeOnEsc = true, closeOnOverlayClick = true, container, showCloseIcon = true, closeIconId, closeIcon, focusTrapped = true, initialFocusRef = void 0, animationDuration = 300, classNames, styles, role = "dialog", ariaLabel, ariaDescribedby, ariaLabelledby, containerId, modalId, onClose, onEscKeyDown, onOverlayClick, onAnimationEnd, children, reserveScrollBarGap }, ref) => {
  ...
  return showPortal && containerModal ? (0, import_react_dom.createPortal)((0, import_jsx_runtime.jsxs)("div", {
    className: (0, import_classnames.default)(classes.root, classNames?.root),
    style: styles?.root,
    "data-testid": "root",
    children: [(0, import_jsx_runtime.jsx)("div", {
      className: (0, import_classnames.default)(classes.overlay, classNames?.overlay),
      "data-testid": "overlay",
      "aria-hidden": true,
      style: {
      ...
      ref: refModal,
      id: containerId,
      className: (0, import_classnames.default)(classes.modalContainer, center && classes.modalContainerCenter, classNames?.modalContainer),
      style: styles?.modalContainer,
      "data-testid": "modal-container",
      onClick: handleClickOverlay,
      children: (0, import_jsx_runtime.jsxs)("div", {
        ref: refDialog,
        className: (0, import_classnames.default)(classes.modal, classNames?.modal),
        style: {
