...
true ? Dialog.propTypes = {
   ...
   * @default true
   */
  "aria-modal": import_prop_types4.default.oneOfType([import_prop_types4.default.oneOf(["false", "true"]), import_prop_types4.default.bool]),
  /**
  ...
  slotProps: import_prop_types4.default.shape({
    ...
    container: import_prop_types4.default.oneOfType([import_prop_types4.default.func, import_prop_types4.default.object]),
  ...
  slots: import_prop_types4.default.shape({
    ...
    container: import_prop_types4.default.elementType,
...
var DialogActions = React6.forwardRef(function DialogActions2(inProps, ref) {
  ...
  return (0, import_jsx_runtime6.jsx)(DialogActionsRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var DialogContent = React7.forwardRef(function DialogContent2(inProps, ref) {
  ...
  return (0, import_jsx_runtime7.jsx)(DialogContentRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItemButton = React8.forwardRef(function ListItemButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime8.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime8.jsx)(ListItemButtonRoot, {
      ref: handleRef,
...
var ListItemSecondaryAction = React9.forwardRef(function ListItemSecondaryAction2(inProps, ref) {
  ...
  return (0, import_jsx_runtime9.jsx)(ListItemSecondaryActionRoot, {
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    ...other
...
var ListItem = React10.forwardRef(function ListItem2(inProps, ref) {
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime10.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime10.jsxs)(ListItemContainer, {
        as: ContainerComponent,
        className: clsx_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState,
        ...ContainerProps,
        children: [(0, import_jsx_runtime10.jsx)(Root, {
          ...rootProps,
  ...
  return (0, import_jsx_runtime10.jsx)(ListContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime10.jsxs)(Root, {
      ...rootProps,
      as: Component,
      ref: handleRef,
      ...!isHostComponent_default(Root) && {
      ...
      ...componentProps,
      children: [children, secondaryAction && (0, import_jsx_runtime10.jsx)(SecondaryActionSlot, {
...
true ? ListItem.propTypes = {
  ...
  slotProps: import_prop_types9.default.shape({
    root: import_prop_types9.default.object,
    secondaryAction: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.object])
  }),
  /**
   * The components used for each slot inside.
   *
  ...
  slots: import_prop_types9.default.shape({
    root: import_prop_types9.default.elementType,
    secondaryAction: import_prop_types9.default.elementType
  }),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var Tab = React12.forwardRef(function Tab2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTab"
  });
  ...
  const icon = iconProp && label && React12.isValidElement(iconProp) ? React12.cloneElement(iconProp, {
    className: clsx_default(classes.icon, iconProp.props.className)
  }) : iconProp;
  ...
  return (0, import_jsx_runtime12.jsxs)(TabRoot, {
    ...
    ...other,
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime12.jsxs)(React12.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime12.jsxs)(React12.Fragment, {
      children: [label, icon]
    }), indicator]
  });
});
...
var TabScrollButton = React13.forwardRef(function TabScrollButton2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabScrollButton"
  });
  ...
  return (0, import_jsx_runtime15.jsx)(TabScrollButtonRoot, {
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime15.jsx)(StartButtonIcon, {
      ...startButtonIconProps
    }) : (0, import_jsx_runtime15.jsx)(EndButtonIcon, {
      ...endButtonIconProps
    })
  });
});
...
function ScrollbarSize(props) {
  ...
  const scrollbarHeight = React14.useRef();
...
var Tabs = React15.forwardRef(function Tabs2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTabs"
  });
  ...
  const [indicatorStyle, setIndicatorStyle] = React15.useState(defaultIndicatorStyle);
  const [displayStartScroll, setDisplayStartScroll] = React15.useState(false);
  const [displayEndScroll, setDisplayEndScroll] = React15.useState(false);
  const [updateScrollObserver, setUpdateScrollObserver] = React15.useState(false);
  const [scrollerStyle, setScrollerStyle] = React15.useState({
    overflow: "hidden",
    scrollbarWidth: 0
  });
  const valueToIndex = /* @__PURE__ */ new Map();
  const tabsRef = React15.useRef(null);
  const tabListRef = React15.useRef(null);
  const externalForwardedProps = {
    slots,
    slotProps: {
  ...
  const handleScrollbarSizeChange = React15.useCallback((scrollbarWidth) => {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime17.jsx)(ScrollbarSlot, {
      ...scrollbarSlotProps,
      onChange: handleScrollbarSizeChange
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime17.jsx)(ScrollButtonsSlot, {
      direction: isRtl ? "right" : "left",
      onClick: handleStartScrollClick,
      disabled: !displayStartScroll,
      ...scrollButtonSlotProps
    }) : null;
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime17.jsx)(ScrollButtonsSlot, {
  ...
  const indicator = (0, import_jsx_runtime17.jsx)(IndicatorSlot, {
    ...indicatorSlotProps
  });
  let childIndex = 0;
  const children = React15.Children.map(childrenProp, (child) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime17.jsxs)(ScrollerSlot, {
      ...scrollerSlotProps,
...
true ? Tabs.propTypes = {
  ...
  slotProps: import_prop_types14.default.shape({
    ...
    indicator: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]),
    ...
    scrollbar: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]),
    scrollButtons: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]),
    scroller: import_prop_types14.default.oneOfType([import_prop_types14.default.func, import_prop_types14.default.object]),
  ...
  slots: import_prop_types14.default.shape({
    ...
    EndScrollButtonIcon: import_prop_types14.default.elementType,
    indicator: import_prop_types14.default.elementType,
    list: import_prop_types14.default.elementType,
    root: import_prop_types14.default.elementType,
    scrollbar: import_prop_types14.default.elementType,
    scrollButtons: import_prop_types14.default.elementType,
    scroller: import_prop_types14.default.elementType,
...
//# sourceMappingURL=chunk-QQWKIF4M.js.map
